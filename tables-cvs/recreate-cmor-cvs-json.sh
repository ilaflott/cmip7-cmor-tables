...
ESGVOC_REVISION="${ESGVOC_REVISION:=13e8f10635657ef425b02da7bb728f04313c03b5}"
...
UNIVERSE_CVS_BRANCH="${UNIVERSE_CVS_BRANCH:=org-model-link}"
# CMIP7_CVS_FORK="${CMIP7_CVS_FORK:=WCRP-CMIP}"
# CMIP7_CVS_BRANCH="${CMIP7_CVS_BRANCH:=esgvoc}"
CMIP7_CVS_FORK="${CMIP7_CVS_FORK:=WCRP-CMIP}"
CMIP7_CVS_BRANCH="${CMIP7_CVS_BRANCH:=org-model-link}"
